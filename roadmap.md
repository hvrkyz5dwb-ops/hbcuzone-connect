...
- [x] Audit placeholder content and unfinished visible features
- [x] Add guest entry and public browsing without redirect loops
- [x] Gate account-only actions with return-to-screen sign-in prompt
- [x] Remove incomplete content and unsafe image fallbacks
- [x] Verify clean install, guest routes, authenticated safety flows, images, iPad layouts
- [x] Run production build and report changed files
- [x] Change the Home greeting from “Built for HBCU Students” to “Hello {student name}”
