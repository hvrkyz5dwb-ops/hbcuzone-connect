...
// Paid digital upgrades (seller memberships, promotion boosts and Plug
// Reach packages) are not sold in this release. Only physical goods and
// real-world services are charged for, through the checkout flows above.
