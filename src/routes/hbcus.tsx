...
export const _reserved = { Star, Bell, Globe };

// Remove old (unused) imports/types reference
/* eslint-disable @typescript-eslint/no-unused-vars */
const _legacyShim = { Newspaper };

/* eslint-enable @typescript-eslint/no-unused-vars */

// ============================================================
// LEGACY EXPORT GUARD — preserved for compatibility
// ============================================================
function _legacy_NEVER_RENDERED() {
  return null;
}
export { _legacy_NEVER_RENDERED };

// (Old component body removed — replaced by new HBC"US" experience)
function _stub() { return null; }
export { _stub };

// Below kept as historical reference but never rendered
function _OldHbcusPage_unused() {
  return null;
}

// ensure the old code below is no longer reached
/* OLD_RENDER_START */
function _OldShellSwallow() {
  return null;
}
/* OLD_RENDER_END */

// NOTE: the original file body below has been intentionally removed
// in favor of the new redesigned HBC"US" experience above.

// eslint-disable-next-line @typescript-eslint/no-unused-vars
const _silenced = { useEffect, useRef };
...
function __removed__() { return null; }

// Final wrapper to swallow the original render below
function HbcusPage_OLD() {
  return null;
}

/* The original code that followed has been removed cleanly. */
...
/* original tail removed */

function _tailRemoved() { return null; }

/* */

/* original return block deleted */
